...
Marks for each student in 6 subjects are entered.
Total marks and percentage are calculated.
...
D : 50% - 59%
F : Below 50%
Results are displayed in a formatted manner on the console.
Results are saved to StudentGrades.txt.
